...
def drawSnowball(x, y, circleSize):
    t.penup()
    t.goto(x, y)
    t.pendown()
    t.color("black")
...
drawSnowball(0, 100, 8)

drawSnowball(0, 10, 8 + 2) # Make the middle snowball a little bigger than the top one

drawSnowball(0, -105, 8 + 4) # Make the bottom snowball bigger than the middle one

# Draw nose of size 1 at (0,50)
noseSize = 1
drawCarrotNose(0, 50, noseSize)

# Draw eyes of size 0.75 at (-15,65) and (15, 65)
eyeSize = 0.75
x = 0
y = 100
drawCharcoalEye(-15, 65, eyeSize)
drawCharcoalEye(15, 65, eyeSize)
